...
function escolheOpcao(opcao) {
    ...
    switch (opcao) {
        case 1:
            ...
            numero = Number(prompt('Informa o número da conta:'))
            conta = bd.lerConta(numero)
            console.log("O saldo do(a) " + conta.cliente.nome + " é:" + conta._saldo)
            break;
        case 2:
        ...
        case 4:
            ...
            novaConta._saldo = Number(prompt('Informe valor do saldo inicial:'));
